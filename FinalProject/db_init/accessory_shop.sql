...
-- Update products table with sample image URLs
UPDATE products SET image_url = 'https://via.placeholder.com/450x300/1a1a1a/ffffff?text=iPhone+15+Case' WHERE product_id = 1;
UPDATE products SET image_url = 'https://via.placeholder.com/450x300/2d3436/ffffff?text=Samsung+S24+Case' WHERE product_id = 2;
UPDATE products SET image_url = 'https://via.placeholder.com/450x300/007bff/ffffff?text=USB-C+Charger' WHERE product_id = 3;
UPDATE products SET image_url = 'https://via.placeholder.com/450x300/f39c12/ffffff?text=Lightning+Cable' WHERE product_id = 4;
UPDATE products SET image_url = 'https://via.placeholder.com/450x300/8e44ad/ffffff?text=Wireless+Earbuds' WHERE product_id = 5;
UPDATE products SET image_url = 'https://via.placeholder.com/450x300/e74c3c/ffffff?text=BT+Speaker' WHERE product_id = 6;
UPDATE products SET image_url = 'https://via.placeholder.com/450x300/27ae60/ffffff?text=Car+Mount' WHERE product_id = 7;
UPDATE products SET image_url = 'https://via.placeholder.com/450x300/34495e/ffffff?text=Screen+Protector' WHERE product_id = 8;
